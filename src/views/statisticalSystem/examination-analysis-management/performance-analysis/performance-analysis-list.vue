...
<div>
  ...
  <el-card :style="style">
    ...
    <el-table class="t-table-list" ref="multipleTable" stripe size="small" :data="tableData" tooltip-effect="dark" style="width:100%;" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="examName" sortable label="考试名称" show-overflow-tooltip align="center">
      ...
      <el-table-column prop="sponsorUnitName" label="考试主管单位" align="center"></el-table-column>
      <el-table-column prop="sponsorUnitName" label="成绩提交状态" align="center"></el-table-column>
      <el-table-column  fixed="right" label="操作" width="220" align="center">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click="viewAnalysis(scope.row)">查看分析</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
    ...
    <!-- 分析详情 -->
    <analysis-info :dataForm="editForm" :visible.sync="analysisVisible"></analysis-info>
...
import analysisInfo from './performance-analysis-infomation' // 分析详情
export default {
  components: {pagination, arrgentInfo, analysisInfo},
  data () {
    return {
      style: '',
      conditionForm: {},
