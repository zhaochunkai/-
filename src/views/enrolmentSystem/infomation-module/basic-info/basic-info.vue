  ...
  <el-form class="t-operate-filter"  :model="basicForm" size="small">
    <el-col :span="12">
      ...
      <el-form-item label="出生日期" label-width="120px">
        <div class="t-info-div">{{new Date(basicForm.birthday).toLocaleDateString()}}</div>
      </el-form-item>
  ...
  <el-form class="t-operate-filter" :model="basicForm" size="small">
    <el-col :span="12">
      ...
      <el-form-item label="报名时间" label-width="120px">
        <div class="t-info-div">{{new Date(basicForm.registrationTime).toLocaleDateString()}}</div>
      </el-form-item>
    ...
    <el-col :span="12">
      ...
      <el-form-item label="报名审核时间" label-width="120px">
        <div class="t-info-div">{{new Date(basicForm.auditTime).toLocaleDateString()}}</div>
      </el-form-item>
    </el-col>
  </el-form>
  <el-dialog class="t-dialog" :title="`${basicForm.name}的照片`" v-if="visible" :visible="visible" :close-on-click-modal="false" width="60%" @close="close">
