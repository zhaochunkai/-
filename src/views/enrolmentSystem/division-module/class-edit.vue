...
<el-dialog class="t-dialog" :title="form.id?'编辑班级': '新增班级'" v-if="visible" :visible="visible" :close-on-click-modal="false" width="500px" @close="close">
  <div>
    <div class="topBtn" v-show="form.id?true:false">
      ...
      <el-button type="primary" size="small" @click="clear">清空该班学生</el-button>
    </div>
    <el-form class="t-form-block" ref="form" :model="form" :rules="rules" label-width="100px" size="small">     
      ...
      <!-- <el-form-item label="班主任id">
        <el-input v-model="form.classTutorId" :disabled="true"></el-input>
      </el-form-item>      -->
      <!-- <el-form-item label="班级已有">
...
import { 
  getClassInfoById,createClass,updateClass,deleteClass,SetClearClassStudent
