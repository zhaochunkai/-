<template>
  <el-dialog class="t-dialog" :title="form.id?'编辑项目信息': '新增项目信息'" v-if="visible" :visible="visible" :close-on-click-modal="false" width="50%" @close="close">
    <el-form class="t-form-block" ref="form" :model="form" :rules="rules" label-width="130px" size="small">
      <el-row :gutter="20">
        <el-col :span="12">
          ...
          <el-form-item label="报名开始时间" prop="recruitStudentsStartDate">
            <el-date-picker v-model="form.recruitStudentsStartDate" type="date" placeholder="选择日期" value-format="yyyy-MM-dd" :picker-options="pickerOptions"> </el-date-picker>
          </el-form-item>
          <el-form-item label="是否限制人数" prop="limit">
            <el-radio-group v-model="form.limit">
              <el-radio :label="true">是</el-radio>
              <el-radio :label="false">否</el-radio>
            </el-radio-group>
          </el-form-item>
          <el-form-item label="学习人脸识别间隔" prop="onlineFaceAttendanceCycle">
            ...
            <el-tag>对所有课程在线学习时进行人脸识别，0表示不启用</el-tag>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          ...
          <el-form-item label="学习费用" prop="charge" >
            <el-input v-model.number="form.charge" :min="0">
              <el-button slot="append">元</el-button>
            </el-input>
          </el-form-item>
          <el-form-item label="报名结束时间" prop="recruitStudentsStopDate">
            <el-date-picker v-model="form.recruitStudentsStopDate" type="date" placeholder="选择日期" value-format="yyyy-MM-dd" :picker-options="pickerOptions"> </el-date-picker>
          </el-form-item>
          ...
          <el-form-item label="直播人脸识别间隔" prop="liveFaceAttendanceCycle">
    ...
    <el-dialog title="请选择机构" :visible.sync="treeVisible" width="30%" append-to-body :before-close="handleClose">
      <tree-checkbox ref="CheckboxTree" treeType="Faculty" :isMultiple="false" :checkBoxLevel="checkBoxLevel" :currentNodeKeysAll="currentNodeKeysAll" @transmitCheckedList="getTransmitCheckedList"></tree-checkbox>
      <span slot="footer" class="dialog-footer">
