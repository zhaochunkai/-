<template>
  <el-dialog class="t-dialog" :title="form.id?'编辑报名': '新增报名'" v-if="visible" :visible="visible" :close-on-click-modal="false" width="60%" @close="close">
    <div v-if="!this.dataForm.id">
      ...
      <el-form class="t-form-block" :inline="true" :rules="rules" label-width="120px" size="small">
...
import { getStudentBasicInfoById,CheckStudentInfoPresence,createStudentEntryAgainEnroll } from '@/server/training-module';
