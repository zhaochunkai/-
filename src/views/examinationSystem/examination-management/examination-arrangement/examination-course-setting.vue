...
<div>  <!-- 考试安排：设置考场和试卷等 -->
  <el-row :gutter="10">
    <el-col :span="5">
      <el-card :style="style">
        <!-- 班级树 -->
        <el-tree :data="resourceTree" ref="tree" node-key="id" default-expand-all :expand-on-click-node="false" :render-content="renderContent"></el-tree>
      </el-card>
    </el-col>
    <el-col :span="19">
...
import { SaveAssignSubject,UpdateArrange,getExaminationArrangeById,getFlagLecturerBycourse } from '@/server/examination-module';
...
export default {
  ...
  watch: {
    ...
    classId(newVal) {
      this.tableData=[]
      this.chooseValue= []
      if (newVal==this.assignSubject.classId) {
