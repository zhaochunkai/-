  ...
  <el-card :style="style">
    ...
    <el-form class="t-operate-filter" :inline="true" :model="conditionForm" size="small">
      ...
      <el-form-item label="考试类型">
        <el-select v-model="conditionForm.examinationTy" clearable>
    ...
    <el-table class="t-table-list" ref="multipleTable" stripe size="small" :data="tableData" tooltip-effect="dark" style="width:100%;" @selection-change="handleSelectionChange">
      ...
      <el-table-column  fixed="right" label="操作" width="220" align="center">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click="viewPerformance(scope.row)">查询成绩</el-button>
        </template>
      </el-table-column>
    </el-table>	
    <!-- 分页组件 -->
...
import courseList from '../../performance-management/performance-module/performance-examination-course-list' // 考试-班级课程列表
export default {
  components: {orgTree, pagination, arrgentInfo, courseList},
  data() {
    return {
      style: '',
      conditionForm: {},
