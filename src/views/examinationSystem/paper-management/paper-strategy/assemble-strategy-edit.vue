          ...
          <el-form class="t-form-block" ref="form" :model="form" :rules="rules" label-width="100px" size="small">
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                ...
                <el-select v-model="trainingProgramsId" remote filterable clearable :remote-method="remoteMethod" placeholder="请输入项目名称检索" :disabled="form.id?true: false">
...
export default {
  ...
  watch: {
    ...
    'form.totalPoints' (newVal) {
      if (newVal < 1) {
        this.$set(this.form, 'totalPoints', 1)
      }
    },
