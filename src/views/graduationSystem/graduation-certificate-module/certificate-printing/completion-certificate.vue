  ...
  <div class="content" id="printCompletion">
    ...
    >
      <div class="leftImg_content">
        <div class="c_top">
          <div class="top_logo">
            <img :src="data.logoImgUrl" height="80px" alt />
            <p style="font-size:24px;margin-left:20px;letter-spacing:6px">{{data.schoolName}}</p>
          </div>
          <p style="font-size:40px;margin:0;letter-spacing:12px">结业证书</p>
        </div>
        <div class="c_center">
          <div style="width:120px;height:120px;">
            <img :src="data.photo" height="120px" alt />
          </div>
        ...
        <div class="c_bot">
          ...
          <img :src="data.officialSealImgUrl" alt class="bot_img" height="120px" />
        </div>
      </div>
    </div>
