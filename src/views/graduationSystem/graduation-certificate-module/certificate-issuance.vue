        ...
        >
          ...
          <el-form class="t-form-block" ref="form" size="small" inline>
            ...
            <el-form-item label="证书类型">
              <el-select v-model="conditionForm.CertificateType" filterable>
                <el-option
          ...
          >
            ...
            <el-table-column prop="semesterName" label="学期" width="50"></el-table-column>
            <el-table-column prop="className" label="班级" width="80"></el-table-column>
            <el-table-column prop="projectName" label="培训项目" width="80"></el-table-column>
            <el-table-column prop="graduationTime" label="毕业年月" width="80">
              <template
                slot-scope="scope"
            ...
            <el-table-column prop="grantStatus" label="是否发放证书" width="94">
              <template slot-scope="scope">
                <div
                  style="margin: 8px 0"
                  v-for="item in scope.row.certificateGrantInfoList"
            ...
            <el-table-column prop="grantTime" label="发证日期" width="100">
              <template slot-scope="scope">
                <div
                  style="margin: 8px 0"
                  v-for="item in scope.row.certificateGrantInfoList"
  ...
  methods: {
    toInfomationPage(row) {
      ...
      this.addEditForm = {
        ...
        programId: row.trainingProgramId
      };
    ...
    queryList() {
      this._GetGraduationStudentInfo(this.SkipCount, this.pageSize);
    },
    //-----------------------------获取证书发放信息--------------------------------
    /*------------------------------------ 操作 --------------------------*/
