    ...
    <el-card :style="style">
      <div class="beforeShow">
        ...
        <el-form class="t-operate-filter" :inline="true" size="small">
          <el-form-item>
            <!-- <el-button type="primary" style="width:100px" @click="addCert">增加</el-button> -->
            <!-- <el-button type="primary" @click="DeleteCert">删除</el-button> -->
          </el-form-item>
          <el-form-item>
            <el-button type="primary" style="width:100px" @click="EnableCert">启用</el-button>
          </el-form-item>
          <el-form-item>
            <el-button type="primary" style="width:100px" @click="DisableCert">禁用</el-button>
          </el-form-item>
        </el-form>
        <!-- 证书列表 -->
        <el-table
        ...
        >
          ...
          <el-table-column fixed="right" label="操作" width="200" align="center">
            <template slot-scope="scope">
              <div v-if="scope.row.certificateName!='学士学位证书'">
                <el-button
                  type="primary"
                  size="mini"
