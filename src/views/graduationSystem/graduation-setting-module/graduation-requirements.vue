  ...
  <div>
    ...
    <el-card :style="style">
      ...
      >
        ...
        <el-table-column prop="studentName" sortable label="姓名" show-overflow-tooltip width="80"></el-table-column>
        <el-table-column prop="tel" label="电话" width="100"></el-table-column>
        <el-table-column prop="sex" label="性别" width="50"></el-table-column>
        <el-table-column prop="trainingProgramsName" label="培训项目" width="120" show-overflow-tooltip></el-table-column>
        <el-table-column prop="className" label="班级" show-overflow-tooltip width="120"></el-table-column>
        <el-table-column prop label="提交时间" show-overflow-tooltip>
          <template
            slot-scope="scope"
          >{{scope.row.submitTime==null?"":new Date(scope.row.submitTime).toLocaleDateString()}}</template>
        </el-table-column>
        <el-table-column prop="approver" label="审批人" show-overflow-tooltip width="80"></el-table-column>
        <el-table-column prop label="审批时间" show-overflow-tooltip>
          <template
            slot-scope="scope"
          >{{scope.row.processingTime==null?"":new Date(scope.row.processingTime).toLocaleDateString()}}</template>
        </el-table-column>
        <el-table-column prop="judgementStatus" label="状态" show-overflow-tooltip width="80"></el-table-column>
        <el-table-column prop="approvalComments" label="备注" show-overflow-tooltip></el-table-column>
