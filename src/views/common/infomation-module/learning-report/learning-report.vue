  ...
  <div class="student-detail-container" id="printContent">
    <div class="tab">
      ...
      <div class="online-study" v-for="item in onlineStudyData" :key="item.courseName">
        ...
        >
          <el-table-column prop="title" label="章节目录" align="left" width></el-table-column>
          <el-table-column prop="cumulativeTime" label="累计学习时长" align="center" width></el-table-column>
          <el-table-column prop label="学习时间段" align="center">
            <template slot-scope="scope">{{scope.row.studyStartTime}}—{{scope.row.studyEndTime}}</template>
          </el-table-column>
          <el-table-column prop label="人脸验证记录（前、后）" align="center">
            <template slot-scope="scope">
              <div style="display:flex;justify-content:center">
                <el-image :src="item.facial[0]" style="margin-right:4px;width:50%"></el-image>
                <el-image :src="item.facial[1]" style="margin-left:4px;width:50%"></el-image>
              </div>
            </template>
          </el-table-column>
        </el-table>
      ...
      <div class="statistics-table">
        ...
        >
          ...
          <el-table-column label="人脸识别记录（前、后）" align="center">
            <template slot-scope="scope">
              <div style="display:flex;justify-content:center">
                <el-image :src="scope.row.facial[0]" style="margin-right:4px;width:50%"></el-image>
                <el-image :src="scope.row.facial[1]" style="margin-left:4px;width:50%"></el-image>
              </div>
            </template>
          </el-table-column>
        </el-table>
  ...
  methods: {
    ...
    _GetInstitutionsBasicInfo() {
      GetInstitutionsBasicInfo().then(res => {
        this.officialIMG = res.officialSealImgUrl;
      });
    },
    //---------------------------------------------------------------------------
    //-------------------------------------获取成绩-------------------------------
