...
<script>
import { getDefaultSemester,getDictionaryItems } from '@/server/basic-module';
import { getTrainingProgramsList,getTrainingProgramsBindCourse } from '@/server/training-module';
import { 
  getEvaluationPlanById,getEvaluationIndicator,getEvaluationPlanIndicator,
  createEvaluationPlan,updateEvaluationPlan
