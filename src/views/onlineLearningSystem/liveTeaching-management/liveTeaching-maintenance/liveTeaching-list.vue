...
<div>
  <el-card :style="style">
    ...
    <el-form class="t-operate-filter" :inline="true" :model="conditionForm" size="small">
      ...
      <el-form-item label="最近">
        <div style="display:flex;">
          <el-input v-model.number="conditionForm.passAverageScore" type="age"></el-input>
          <span style="width:60px;display:inline-block;margin-left:5px;"> 天以内</span>
        </div>
      </el-form-item> -->
    ...
    <div class="t-operate-buttons">
      ...
      <el-button type="primary" size="mini" @click="del()">停播</el-button> -->
    ...
    <el-table class="t-table-list" ref="multipleTable" stripe size="small" :data="tableData" tooltip-effect="dark" style="width: 100%;margin-top: 10px;" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="planStartTime" label="计划开始时间">
        <template slot-scope="scope">
          {{new Date(scope.row.planStartTime).toLocaleString()}}
        </template>
      </el-table-column>
      <el-table-column prop="section" label="直播人数" width="80"></el-table-column>
      <!-- <el-table-column prop="headcount" label="直播简介" show-overflow-tooltip></el-table-column> -->
...
export default {
  ...
  components: {pagination, addEdit, treeTransfer, analysisList},
  activated () {
    this.conditionForm = {}
  ...
  methods: {
    ...
    initDataList (SkipCount = 0, pageSize = this.pageSize) {
      let data = {
        ...
        anchorId: this.conditionForm.anchorId ? this.conditionForm.anchorId : '00000000-0000-0000-0000-000000000000',
        CourseId: this.conditionForm.courseId ? this.conditionForm.courseId : -1,
        TrainingProgramId: this.conditionForm.trainingProgramId ? this.conditionForm.trainingProgramId : -1
      }
