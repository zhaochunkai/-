...
<div>
  <el-form class="t-operate-filter" :model="basicForm" size="small">
    <el-col :span="12">
      ...
      <el-form-item label="适用课程" label-width="120px">
          <el-input class="input-append"  v-model="basicForm.payStatus" :readonly="true"></el-input>
      </el-form-item>
    </el-col>
    <el-col :span="12">
      ...
      <el-form-item label="建议学习时长" label-width="120px">
        <div class="t-info-div">
          <span v-if="basicForm.suggestedLearningTime">{{basicForm.suggestedLearningTime.split(': ')[0]}}时{{basicForm.suggestedLearningTime.split(': ')[1]}}分{{basicForm.suggestedLearningTime.split(': ')[2]}}秒</span>
        </div>        
      </el-form-item>
