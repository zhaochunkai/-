    ...
    <el-card :style="style">
        <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="校区详情" name="first">
                <el-form class="t-form-block" ref="form" :model="campusData" :rules="rules" label-width="120px" size="small">
                    <el-row>
                        <el-col :span="12">
            ...
            <el-tab-pane label="直属机构" name="second">
                <el-form class="t-operate-filter" :inline="true" :model="conditionForm" size="small">
                    <el-form-item label="机构名称">
                        <el-input class="input-append"  v-model="conditionForm.InstitutionName" placeholder="请输入机构名称"></el-input>	
                    </el-form-item>
	...
	methods: {
		...
		save () {
			this.$refs.form.validate((valid) => {
				if (!valid) return;
				updateCampus(this.campusData).then(result => {
					this.$message.success('保存成功')
					this.$emit('updateSchoolTree')
				}).catch(err => { 
					this.$message({
