...
// 更新学校信息
export const updateSchool = (data) => http('/Api/School/?id=' + data.id, data, 'PUT')
...
/* ------------------------------ 基础数据-教室场所------------------------------------- */
// 创建场地
export const createSite = (data) => http('/Api/Site', data, 'POST')
// 分页获取场地列表，可以根据教室名称，可用状态进行查询
export const getSiteList = (data) => http('/Api/Site', data)
// 删除场地
export const deleteSite = (data) => http('/Api/Site/' + data.id, data, 'DELETE')
// 根据Id获取场地信息
export const getSiteById = (id) => http('/Api/Site/' + id, {})
// 更新场地信息
export const updateSite = (data) => http('/Api/Site/' + data.id, data, 'PUT')
// 修改场地状态
export const updateSiteStatus = (data) => http('/Api/Site/Status?id=' + data.id + '&Status=' + data.status, data, 'PUT')
// 根据楼栋查询场地，不分页
export const getSiteListByBuilding = (buildingId) => http('/Api/Site/ByBuilding?buildingId=' + buildingId, {})
// 获取场地下拉框数据
export const getSiteDropdown = (data) => http('/Api/Site/GetSiteSpinnerData', data)
/* ------------------------------ 基础数据-楼栋信息------------------------------------- */
// 创建楼栋
...
//获取证书发放详情
export const GetCertificateCoreLatest = (data) => http(`/Api/CertificateGrant/GetCertificateCoreLatest?type=${data.type}&studentIds=[${data.studentIds}]&classId=${data.classId}&certificateId=${data.certificateId}`, {})
//证书启用或禁用
