...
// 增加资源浏览量
export const updateResourceBroswerCount = (id) => http('/Api/Resource/IncreaseViewsCount?id=' + id, {}, 'PUT')
// 增加资源下载量 
export const updateResourceDownloadCount = (id) => http('/Api/Resource/IncreaseDownloadCount?id=' + id, {}, 'PUT')
// 设置建议学习时长
...
/* ------------------------------ 【在线培训系统】-课程组装---章/节-------------------------------------- */
// 获取章节信息详情
export const getChapterSectionById = (id) => http('/Api/ChapterSection/' + id, {})
// 更新章节信息
export const updateChapterSection = (data) => http('/Api/ChapterSection?id=' + data.id, data, 'PUT')
// 删除章节信息
export const deleteChapterSection = (data) => http('/Api/ChapterSection?id=' + data.id, data, 'DELETE')
// 创建章节
export const createChapterSection = (data) => http('/Api/ChapterSection', data, 'POST')
// 获取章节信息，课程知识点管理使用
export const getChapterSectionList = (data) => http('/Api/ChapterSection', data)
// 为章节绑定资源
export const ChapterSectionBind = (id, data) => http('/Api/ChapterSection/Bind?id=' + id, data, 'PUT')
// 章节解绑资源
export const ChapterSectionUnBind = (id, resourceId) => http('/Api/ChapterSection/Unbind?id=' + id + '&resourceId=' + resourceId, {}, 'PUT')
// 设置章节排序序号
export const updateChapterSectionOrder = (data) => http('/Api/ChapterSection/SetOrder', data, 'PUT')
// 获取章节下的资源列表
export const getChapterSectionResources = (id) => http('/Api/ChapterSection/Resources?id=' + id, {})

/* ------------------------------ 【在线培训系统】-课程组装-知识点-------------------------------------- */
// 课程知识点列表查询
export const getKnowledgePoint = (data) => http('/Api/KnowledgePoint', data)
// 创建知识点
export const createKnowledgePoint = (data) => http('/Api/KnowledgePoint', data, 'POST')
// 修改知识点
export const updateKnowledgePoint = (data) => http('/Api/KnowledgePoint?id=' + data.id, data, 'PUT')
// 删除课程知识点
export const deleteKnowledgePoint = (data) => http('/Api/KnowledgePoint?id=' + data.id, data, 'DELETE')
// 知识点详情查询
export const getKnowledgePointById = (id) => http('/Api/KnowledgePoint/' + id, {})
// 为知识点绑定资源
export const KnowledgePointBind = (id, data) => http('/Api/KnowledgePoint/Bind?id=' + id, data, 'PUT')
// 知识点解绑资源
export const KnowledgePointUnbind = (id, resourceId) => http('/Api/KnowledgePoint/Unbind?id=' + id + '&resourceId=' + resourceId, {}, 'PUT')
// 覆盖试题知识点
export const KnowledgePointMergeQuestionKp = (data) => http('/Api/KnowledgePoint/MergeQuestionKp', data, 'PUT')
// 设置知识点排序序号
export const updateKnowledgePointOrder = (data) => http('/Api/KnowledgePoint/SetOrder', data, 'PUT')
// 覆盖试题知识点
export const cloneKnowledgePoint = () => http('/Api/KnowledgePoint/MergeQuestionKp', {}, 'PUT')
// 获取知识点下面的资源
export const getKnowledgePointResources = (id) => http('/Api/KnowledgePoint/Resources?id=' + id, {})
...
// 更新直播房间基本信息
export const updateLiveRoomById = (data) => http('/Api/LiveRoom/?id=' + data.id, data, 'PUT')
// 删除直播房间
export const deleteLiveRoomById = (id) => http('/Api/LiveRoom?id=' + id, {}, 'DELETE')
// 获取直播房间详情
...
// 设置考勤状态
export const AttendanceStatus = (data) => http('/Api/Attendance/SetStatus', data, 'PUT')
// 获取考勤管理列表
