...
/* ------------------------------------- 短信/流量 ------------------------------------- */
// 流量支付策略
export const getFluxPayStrategy = (data) => http('/Api/FluxPayStrategy', data)
// 根据流量支付策略Id获得微信支付二维码
export const getFluxPayStrategyCode = (payStrategyId) => http('/Api/FluxPayStrategy/PayQrCode?payStrategyId='+payStrategyId, {})
// 获取流量充值订单列表 
export const getFluxOrder = () => http('/Api/FluxOrder', {})
// 获取直播流量账单
export const getLiveRoomBilling = () => http('/Api/LiveRoom/Billing', {})
// 获取剩余流量
export const getResidueFlux = () => http('/Api/Flux/Residue', {})
// 获得租户的资源流量账单
