...
const state = {
	list: [
		// 基础数据平台
		{ moduleName: '基础平台', menuList: [
			{index: '1', label: '数据字典', children: [
				{index: '1-1', label: '数据字典管理', path: '/data/list/item'}
			]},
			{index: '2', label: '基础数据', children: [
				...
				{index: '2-6', label: '教室场所', path: '/site/list'},
				{index: '2-7', label: '毕业要求证书类型', path: '/certificate/type/list'}
			]},
			{index: '3', label: '统一身份管理', children: [
				{index: '3-1', label: '用户管理', path: '/user/list'},
				{index: '3-2', label: '角色管理', path: '/role/list'}
			]},
			{index: '4', label: '排课设置', children: [
				{index: '4-1', label: '作息时间', path: '/daily/schedule'},
				{index: '4-2', label: '教学日程', path: '/teaching/schedule'}
			]},
			{index: '5', label: '资源库设置', children: [
				{index: '5-1', label: '全局设置', path: '/resource/globalsetting'},
				{index: '5-2', label: '资源库搭建', path: '/resource/list'},
				{index: '5-3', label: '资源库授权', path: '/resource/auth'}
			]},
			{index: '6', label: '消息推送', children: [
				{index: '6-1', label: '短信统计', path: '/message/setting'},
				{index: '6-2', label: '短信充值记录', path: '/msg/recharge/list'}
			]},
			{index: '7', label: '流量管理', children: [
		...
		// 报名录取系统
		{ moduleName: '报名录取', menuList: [
			{index: '1', label: '学习项目', children: [
				{index: '1-1', label: '项目管理', path: '/training/project'}
			]},
			{index: '2', label: '报名管理', children: [
				{index: '2-1', label: '报名管理', path: '/registration/list'}
			]},
			{index: '3', label: '录取管理', children: [
				{index: '3-1', label: '报名审核', path: '/admission/list'}
			]},
			{index: '4', label: '缴费管理', children: [
				{index: '4-1', label: '缴费管理', path: '/pay/list'},
				{index: '4-2', label: '缴费查询', path: '/pay/search/list'}
			]},
			{index: '5', label: '分班管理', children: [
				{index: '5-1', label: '分班管理', path: '/divide/classes'},
				{index: '5-2', label: '学生档案', path: '/student/files'}
			]},
		]},
		// 在线培训系统
		{ moduleName: '在线学习', menuList: [
			{index: '1', label: '资源库管理', children: [
				{index: '1-1', label: '资源维护', path: '/repository/list'},
				{index: '1-2', label: '资源审批', path: '/repository/approval/list'},
				{index: '1-3', label: '资源监管', path: '/repository/supervision/list'},
			]},
			{index: '2', label: '课程组装', children: [
				{index: '2-1', label: '知识点管理', path: '/knowledgePoints/list'},
				{index: '2-2', label: '课程组装', path: '/courseassembly/list'},
			]},
			{index: '3', label: '学习项目', children: [
				{index: '3-1', label: '项目排课', path: '/program/schedule'},
				// {index: '3-2', label: '课表管理', path: '/courseassembly/list'},
			]},
			{index: '6', label: '直播教学', children: [
				{index: '6-1', label: '直播课堂管理', path: '/liveTeaching/list' },
			]},
			{index: '4', label: '考勤管理', children: [
				{index: '4-1', label: '在线考勤', path: '/attendance/code'},
				{index: '4-2', label: '考勤管理', path: '/attendance/list'},
				{index: '4-3', label: '人脸识别考勤', path: '/faceAttendance/list'},
			]},
			{index: '5', label: '评价管理', children: [
		...
		// 毕业管理
		{ moduleName: '毕业管理', menuList: [
			{index: '2', label: '毕业设置', children: [
				{index: '2-1', label: '全局设置', path: '/graduation/setting/global'},
				{index: '2-2', label: '毕业要求', path: '/graduation/setting/requirements'}
			]},
			{index: '1', label: '毕业管理', children: [
				{index: '1-1', label: '毕业判定条件', path: '/graduation/judgement/list'},
				{index: '1-2', label: '毕业管理', path: '/graduation/list'}
			]},
			{index: '3', label: '证书管理', children: [
				{index: '3-1', label: '技能证书管理', path: '/graduation/certificate/skill'},
				{index: '3-2', label: '毕业证书管理', path: '/graduation/certificate/diploma'},
				{index: '3-3', label: '证书发放', path: '/graduation/certificate/issuance'}
			]},
			{index: '4', label: '学生档案', children: [
				{index: '4-1', label: '学生档案', path: '/student/files/list'}
			]},
			{index: '5', label: '佐证材料', children: [
				{index: '5-1', label: '佐证栏目', path: '/evidence/column/list'},
				{index: '5-2', label: '佐证材料', path: '/evidence/materials/list'},
				// {index: '5-3', label: '补贴管理', path: '/subsidy/management/list'},
			]},
		]},
		// 统计分析系统
		{ moduleName: '统计分析', menuList: [
			{index: '1', label: '项目分析', children: [
				{index: '1-1', label: '报名分析', path: '/registration/analysis/charts'},
				{index: '1-2', label: '毕业分析', path: '/graduation/analysis/charts'}
			]},
			{index: '2', label: '学习分析', children: [
				{index: '2-1', label: '学习跟踪', path: '/learning/tracking/list'},
				{index: '2-2', label: '到课率分析', path: '/learning/attendance/list'}
			]},
			{index: '3', label: '考试分析', children: [
				{index: '3-1', label: '分析设置', path: '/examination/analysis/setting'},
				{index: '3-2', label: '成绩分析', path: '/performance/analysist/list'},
				{index: '3-3', label: '考试合格率', path: '/examination/rate/list'}
			]},
			// {index: '4', label: '资源统计', children: [
			// 	{index: '4-1', label: '用户上传统计', path: '/resource/upload/statistics'},
			// 	{index: '4-2', label: '资源分类统计', path: '/resource/classification/statistics'}
			// ]},
			// {index: '5', label: '直通统计', children: [
			// 	{index: '5-1', label: '直播数据分析', path: '/live/data/statistics'},
			// 	{index: '5-2', label: '直播费用流水', path: '/live/fee/flow'}
			// ]},
			// {index: '6', label: '消费统计', children: [
			// 	{index: '6-1', label: '消费明细', path: '/consumption/statistics/list'},
